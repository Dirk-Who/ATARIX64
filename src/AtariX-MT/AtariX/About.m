...
- (id)init
{
	...
	if ([versionString length] == 0)
		versionString = @"AtariX";
	label = [NSTextField labelWithString: versionString];
	[label setAlignment: NSTextAlignmentLeft];
	[vbox2 addView:label inGravity: NSStackViewGravityLeading];
	label = [NSTextField labelWithString: @"Updated and compiled for ARM64/SDL"];
	[label setAlignment: NSTextAlignmentLeft];
	[vbox2 addView:label inGravity: NSStackViewGravityLeading];
	label = [NSTextField labelWithString: @"by Dirk Werth using OpenAI Codex"];
	[label setAlignment: NSTextAlignmentLeft];
	[vbox2 addView:label inGravity: NSStackViewGravityLeading];
