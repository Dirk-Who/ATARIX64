...
static void m68k_op_call_emu_proc(void)
{
	uint32_t a0 = REG_A[0];
	uint32_t a1 = REG_A[1];
...
static void m68k_op_call_emu_cproc(void)
{
	uint32_t a0 = REG_A[0];
	uint32_t a1 = REG_A[1];
	uint32_t* function_slot = (uint32_t*)(m68k_atari_memory_base + a0);
...
/*   function                      mask    match    000  010  020  040 */
	...
	{m68k_op_call_emu_proc       , 0xffff, 0x00c0, {  0,   0,   0,   0,   0}},
	{m68k_op_call_emu_cproc      , 0xffff, 0x00c1, {  0,   0,   0,   0,   0}},
